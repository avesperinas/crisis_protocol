...
class Settings(BaseSettings):
    ...
    # Bots may make one diplomatic move (message / pact proposal) per turn.
    # Set BOT_DIPLOMACY_ENABLED=false to save the extra Claude calls.
    bot_diplomacy_enabled: bool = True
